...
\begin{document}
\tlatex
\@x{}\moduleLeftDash\@xx{ {\MODULE} orchestrator}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} TLC ,\, Naturals ,\, Integers ,\, Sequences}%
\@pvspace{8.0pt}%
\@x{ {\CONSTANT} Workers ,\, Manager ,\, Clients}%
\@pvspace{8.0pt}%
 \@x{ Messages \.{\defeq} [ type \.{:} \{\@w{task} \} ,\, s \.{:} Manager ,\,
 r \.{:} Workers ] \.{\cup}}%
 \@x{\@s{59.85} [ type \.{:} \{\@w{working} ,\,\@w{completed} ,\,\@w{waiting}
 \} ,\, s \.{:} Workers ,\, r \.{:} Manager ] \.{\cup}}%
 \@x{\@s{59.85} [ type \.{:} \{\@w{inprogress} ,\,\@w{finished} \} ,\, s \.{:}
 Manager ,\, r \.{:} Clients ] \.{\cup}}%
 \@x{\@s{59.85} [ type \.{:} \{\@w{doWork} \} ,\, s \.{:} Clients ,\, r \.{:}
 Manager ]}%
\@pvspace{16.0pt}%
\@x{ Actors \.{\defeq} \{ Workers \.{\cup} Manager \.{\cup} Clients \}}%
\@pvspace{8.0pt}%
\pcalsymbolstrue
\csyntaxfalse
\@x{\@s{8.2} {\p@mmalgorithm} orchestrator}%
\@pvspace{8.0pt}%
 \@x{ {\p@variables} msgs \.{=} \{ \} ,\, wState \.{=} [ w \.{\in} Workers
 \.{\mapsto}\@w{waiting} ] ,\,}%
\@x{\@s{55.96} mState \.{=} [ m \.{\in} Manager \.{\mapsto}\@w{ready} ] ,\,}%
 \@x{\@s{55.96} cState\@s{3.57} \.{=} [ c\@s{3.77} \.{\in} Clients\@s{8.07}
 \.{\mapsto}\@w{idle} ] ,\,}%
 \@x{\@s{55.96} queues\@s{1.46} \.{=} [ q\@s{3.46} \.{\in} Actors \.{\mapsto}
 {\langle} {\rangle} ] {\p@semicolon}}%
\@pvspace{16.0pt}%
\@x{ {\p@macro} send ( id ,\, msg ) {\p@begin}}%
\@x{\@s{16.4} queues \.{:=} Append ( queues [ id ] ,\, msg ) {\p@semicolon}}%
\@x{ {\p@end} {\p@macro} {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{ {\p@macro} receive ( msg ) {\p@begin}}%
\@x{\@s{16.4} {\p@await} Len ( queues [ self ] \.{>} 0 ) {\p@semicolon}}%
\@x{\@s{16.4} msg \.{:=} Head ( queues [ self ] ) {\p@semicolon}}%
\@x{\@s{16.4} queues \.{:=} Tail ( queues [ self ] ) {\p@semicolon}}%
\@x{ {\p@end} {\p@macro} {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{ {\p@process} worker \.{\in} Workers}%
\@x{ {\p@variable} workQueue \.{=} {\langle} {\rangle} {\p@semicolon}}%
\@x{ {\p@begin}}%
\@x{\@s{16.4} WaitForWork\@s{.5}\textrm{:}\@s{3}}%
\@x{\@s{32.8} {\p@skip} {\p@semicolon}}%
\@x{\@s{16.4} PerformWork\@s{.5}\textrm{:}\@s{3}}%
\@x{\@s{32.8} {\p@skip} {\p@semicolon}}%
\@pvspace{16.0pt}%
\@x{ {\p@end} {\p@process} {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{ {\p@process} client \.{\in} Clients}%
\@x{ {\p@variable} msg \.{=} {\langle} {\rangle} {\p@semicolon}}%
\@x{ {\p@begin}}%
\@x{\@s{16.4} SendTaskToManager\@s{.5}\textrm{:}\@s{3}}%
\@x{\@s{32.8} {\p@if} msg \.{=} {\langle} {\rangle} {\p@then}}%
\@x{\@s{47.44} {\p@with} m \.{\in} Manager {\p@do}}%
 \@x{\@s{63.84} send ( self ,\, [ type \.{\mapsto}\@w{doWork} ,\, s
 \.{\mapsto} self ,\, r \.{\mapsto} m ] ) {\p@semicolon}}%
\@x{\@s{47.44} {\p@end} {\p@with} {\p@semicolon}}%
\@x{\@s{32.8} {\p@end} {\p@if} {\p@semicolon}}%
\@x{\@s{16.4} ReceiveTaskFinish\@s{.5}\textrm{:}\@s{3}}%
\@x{\@s{32.8} {\p@with} m \.{\in} Manager {\p@do}}%
\@x{\@s{49.19} {\p@if}}%
\@x{\@s{65.6} \.{\land} msgs . type\@s{2.72} \.{=}\@w{finished}}%
\@x{\@s{65.6} \.{\land} mState [ m ] \.{=}\@w{done}}%
\@x{\@s{49.19} {\p@then}}%
\@x{\@s{65.6} receive ( msg ) {\p@semicolon}}%
\@x{\@s{49.19} {\p@else}}%
\@x{\@s{65.6} {\p@goto} SendTaskToManager {\p@semicolon}}%
\@x{\@s{49.19} {\p@end} {\p@if} {\p@semicolon}}%
\@x{\@s{32.8} {\p@end} {\p@with} {\p@semicolon}}%
\@x{ {\p@end} {\p@process} {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{ {\p@process} manager \.{\in} Manager}%
\@x{ {\p@begin}}%
\@x{\@s{16.4} NotifyClientOfCompleteJob\@s{.5}\textrm{:}\@s{3}}%
\@x{\@s{28.69} {\p@if} msgs . type \.{=}\@w{completed} {\p@then}}%
\@x{\@s{47.44} {\p@with} c \.{\in} Clients {\p@do}}%
 \@x{\@s{63.84} send ( self ,\, [ type \.{\mapsto}\@w{finished} ,\, s
 \.{\mapsto} self ,\, r \.{\mapsto} c ] ) {\p@semicolon}}%
\@x{\@s{47.44} {\p@end} {\p@with} {\p@semicolon}}%
\@x{\@s{28.69} {\p@end} {\p@if} {\p@semicolon}}%
\@x{\@s{16.4} ReceiveTaskFromClient\@s{.5}\textrm{:}\@s{3}}%
\@x{\@s{32.8} {\p@skip} {\p@semicolon}}%
\@x{\@s{16.4} GiveTaskToWorker\@s{.5}\textrm{:}\@s{3}}%
\@x{\@s{32.8} {\p@skip} {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{ {\p@end} {\p@process} {\p@semicolon}}%
\@pvspace{16.0pt}%
...
\@x{}%
\@y{\@s{0}%
 BEGIN TRANSLATION (\ensuremath{chksum(pcal) \.{=}} ``\ensuremath{901ddb8f}''
 \ensuremath{\.{\land} chksum(tla) \.{=}} ``\ensuremath{580405ba}'')
}%
\@xx{}%
 \@x{ {\VARIABLES} msgs ,\, wState ,\, mState ,\, cState ,\, queues ,\, pc ,\,
 workQueue ,\, msg}%
\@pvspace{8.0pt}%
 \@x{ vars \.{\defeq} {\langle} msgs ,\, wState ,\, mState ,\, cState ,\,
 queues ,\, pc ,\, workQueue ,\, msg {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ ProcSet \.{\defeq} ( Workers ) \.{\cup} ( Clients ) \.{\cup} ( Manager
 )}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\@s{35.70} \.{\land} msgs \.{=} \{ \}}%
 \@x{\@s{35.70} \.{\land} wState\@s{1.53} \.{=} [ w\@s{1.22} \.{\in}
 Workers\@s{1.66} \.{\mapsto}\@w{waiting} ]}%
 \@x{\@s{35.70} \.{\land} mState \.{=} [ m \.{\in} Manager
 \.{\mapsto}\@w{ready} ]}%
 \@x{\@s{35.70} \.{\land} cState\@s{3.57} \.{=} [ c\@s{3.77} \.{\in}
 Clients\@s{8.07} \.{\mapsto}\@w{idle} ]}%
 \@x{\@s{35.70} \.{\land} queues\@s{1.46} \.{=} [ q\@s{3.46} \.{\in} Actors
...
\@xx{}%
 \@x{\@s{35.70} \.{\land} workQueue \.{=} [ self \.{\in} Workers \.{\mapsto}
 {\langle} {\rangle} ]}%
\@x{\@s{35.70}}%
\@y{\@s{0}%
 Process client
...
\@xx{}%
 \@x{\@s{35.70} \.{\land} msg \.{=} [ self \.{\in} Clients \.{\mapsto}
 {\langle} {\rangle} ]}%
 \@x{\@s{35.70} \.{\land} pc \.{=} [ self \.{\in} ProcSet \.{\mapsto} {\CASE}
 self \.{\in} Workers\@s{1.66} \.{\rightarrow}\@w{WaitForWork}}%
 \@x{\@s{160.39} {\Box}\@s{10.30} self \.{\in} Clients\@s{8.07}
 \.{\rightarrow}\@w{SendTaskToManager}}%
 \@x{\@s{160.39} {\Box}\@s{10.30} self \.{\in} Manager
 \.{\rightarrow}\@w{NotifyClientOfCompleteJob} ]}%
\@pvspace{8.0pt}%
 \@x{ WaitForWork ( self ) \.{\defeq} \.{\land} pc [ self ]
 \.{=}\@w{WaitForWork}}%
\@x{\@s{104.66} \.{\land} {\TRUE}}%
 \@x{\@s{104.66} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{PerformWork} ]}%
 \@x{\@s{104.66} \.{\land} {\UNCHANGED} {\langle} msgs ,\, wState ,\, mState
 ,\, cState ,\, queues ,\,}%
\@x{\@s{178.25} workQueue ,\, msg {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ PerformWork ( self )\@s{0.40} \.{\defeq} \.{\land} pc [ self ]
 \.{=}\@w{PerformWork}}%
\@x{\@s{104.66} \.{\land} {\TRUE}}%
 \@x{\@s{104.66} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{Done} ]}%
...
\@x{\@s{178.25} workQueue ,\, msg {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ worker ( self ) \.{\defeq} WaitForWork ( self ) \.{\lor} PerformWork (
 self )}%
\@pvspace{8.0pt}%
 \@x{ SendTaskToManager ( self ) \.{\defeq} \.{\land} pc [ self ]
 \.{=}\@w{SendTaskToManager}}%
\@x{\@s{135.04} \.{\land} {\IF} msg [ self ] \.{=} {\langle} {\rangle}}%
\@x{\@s{158.31} \.{\THEN} \.{\land} \E\, m \.{\in} Manager \.{:}}%
 \@x{\@s{208.93} queues \.{'} \.{=} Append ( queues [ self ] ,\, ( [ type
 \.{\mapsto}\@w{doWork} ,\, s \.{\mapsto} self ,\, r \.{\mapsto} m ] ) )}%
\@x{\@s{158.31} \.{\ELSE} \.{\land} {\TRUE}}%
\@x{\@s{189.62} \.{\land} {\UNCHANGED} queues}%
 \@x{\@s{135.04} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{ReceiveTaskFinish} ]}%
 \@x{\@s{135.04} \.{\land} {\UNCHANGED} {\langle} msgs ,\, wState ,\, mState
 ,\, cState ,\,}%
\@x{\@s{208.63} workQueue ,\, msg {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ ReceiveTaskFinish ( self )\@s{11.68} \.{\defeq} \.{\land} pc [ self ]
 \.{=}\@w{ReceiveTaskFinish}}%
\@x{\@s{135.04} \.{\land} \E\, m \.{\in} Manager \.{:}}%
\@x{\@s{154.35} {\IF} \.{\land} msgs . type\@s{2.72} \.{=}\@w{finished}}%
\@x{\@s{166.51} \.{\land} mState [ m ] \.{=}\@w{done}}%
\@x{\@s{166.51} \.{\THEN} \.{\land} Len ( queues [ self ] \.{>} 0 )}%
 \@x{\@s{197.82} \.{\land} msg \.{'} \.{=} [ msg {\EXCEPT} {\bang} [ self ]
 \.{=} Head ( queues [ self ] ) ]}%
\@x{\@s{197.82} \.{\land} queues \.{'} \.{=} Tail ( queues [ self ] )}%
 \@x{\@s{197.82} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{Done} ]}%
 \@x{\@s{166.51} \.{\ELSE} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [
 self ] \.{=}\@w{SendTaskToManager} ]}%
\@x{\@s{197.82} \.{\land} {\UNCHANGED} {\langle} queues ,\, msg {\rangle}}%
 \@x{\@s{135.04} \.{\land} {\UNCHANGED} {\langle} msgs ,\, wState ,\, mState
 ,\, cState ,\,}%
\@x{\@s{208.63} workQueue {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ client ( self ) \.{\defeq} SendTaskToManager ( self ) \.{\lor}
 ReceiveTaskFinish ( self )}%
\@pvspace{8.0pt}%
 \@x{ NotifyClientOfCompleteJob ( self ) \.{\defeq} \.{\land} pc [ self ]
 \.{=}\@w{NotifyClientOfCompleteJob}}%
\@x{\@s{163.23} \.{\land} {\IF} msgs . type \.{=}\@w{completed}}%
\@x{\@s{186.49} \.{\THEN} \.{\land} \E\, c \.{\in} Clients \.{:}}%
 \@x{\@s{237.12} queues \.{'} \.{=} Append ( queues [ self ] ,\, ( [ type
 \.{\mapsto}\@w{finished} ,\, s \.{\mapsto} self ,\, r \.{\mapsto} c ] ) )}%
\@x{\@s{186.49} \.{\ELSE} \.{\land} {\TRUE}}%
\@x{\@s{217.81} \.{\land} {\UNCHANGED} queues}%
 \@x{\@s{163.23} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{ReceiveTaskFromClient} ]}%
 \@x{\@s{163.23} \.{\land} {\UNCHANGED} {\langle} msgs ,\, wState ,\, mState
 ,\,}%
\@x{\@s{236.82} cState ,\, workQueue ,\, msg {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ ReceiveTaskFromClient ( self ) \.{\defeq} \.{\land} pc [ self ]
 \.{=}\@w{ReceiveTaskFromClient}}%
\@x{\@s{145.13} \.{\land} {\TRUE}}%
 \@x{\@s{145.13} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{GiveTaskToWorker} ]}%
 \@x{\@s{145.13} \.{\land} {\UNCHANGED} {\langle} msgs ,\, wState ,\, mState
 ,\, cState ,\,}%
\@x{\@s{218.72} queues ,\, workQueue ,\, msg {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ GiveTaskToWorker ( self ) \.{\defeq} \.{\land} pc [ self ]
 \.{=}\@w{GiveTaskToWorker}}%
\@x{\@s{128.59} \.{\land} {\TRUE}}%
 \@x{\@s{128.59} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{Done} ]}%
 \@x{\@s{128.59} \.{\land} {\UNCHANGED} {\langle} msgs ,\, wState ,\, mState
 ,\, cState ,\, queues ,\,}%
\@x{\@s{202.18} workQueue ,\, msg {\rangle}}%
\@pvspace{8.0pt}%
\@x{ manager ( self ) \.{\defeq} NotifyClientOfCompleteJob ( self )}%
\@x{\@s{93.91} \.{\lor} ReceiveTaskFromClient ( self )}%
\@x{\@s{93.91} \.{\lor} GiveTaskToWorker ( self )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} ( \E\, self \.{\in} Workers \.{:} worker ( self ) )}%
 \@x{\@s{47.82} \.{\lor} ( \E\, self \.{\in} Clients\@s{8.07} \.{:} client (
 self ) )}%
\@x{\@s{47.82} \.{\lor} ( \E\, self \.{\in} Manager \.{:} manager ( self ) )}%
...
\@pvspace{16.0pt}%
\@x{ TypeOK \.{\defeq}}%
 \@x{\@s{41.35} \.{\land} wState\@s{1.53} \.{\in} [ Workers\@s{1.66}
 \.{\rightarrow} \{\@w{waiting} ,\,\@w{working} \} ]}%
 \@x{\@s{41.35} \.{\land} mState \.{\in} [ Manager \.{\rightarrow}
 \{\@w{ready} ,\,\@w{busy} ,\,\@w{jobComplete} \} ]}%
 \@x{\@s{41.35} \.{\land} cState\@s{3.57} \.{\in} [ Clients\@s{8.07}
 \.{\rightarrow} \{\@w{assignTask} ,\,\@w{idle} \} ]}%
\@x{\@s{41.35} \.{\land} msgs \.{\subseteq} Messages}%
\@pvspace{24.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Mar} 11 10:40:22 \ensuremath{CET} 2024 by lee
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} \ensuremath{Mar} 08
 22:22:11 \ensuremath{CET} 2024 by lee
\end{cpar}%
\end{lcom}%
\end{document}
